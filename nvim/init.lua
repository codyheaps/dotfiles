...
require('lazy').setup({
  ...
  -- Visual region comment <leader>gc
...
require('nvim-treesitter.configs').setup {
  ensure_installed = { 'php', 'java', 'python', 'typescript', 'vue', 'html', 'javascript', 'lua', 'vimdoc', 'vim' },
  auto_install = false,
...
cmp.setup {
  ...
  -- TODO: Revisit for keymaps I can actually use
